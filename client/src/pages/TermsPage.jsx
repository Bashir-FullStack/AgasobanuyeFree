...
export default function TermsPage() {
 ...
 is not liable for indirect, incidental, or consequential damages arising from the use of our products or services. Our total liability is limited to the purchase price of the product.</p></section>
          ...
          <section><h2 className="text-lg font-bold text-dark mb-3">9. Contact</h2><p>For questions about these terms, contact us at <a href="mailto:bashirfullstack3@gmail.com" className="text-primary hover:underline">bashirfullstack3@gmail.com</a>.</p></section>
        </div>
      </div>
    </div>
  );
